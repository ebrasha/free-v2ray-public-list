...
A simple and always-updated list of free, working V2Ray servers.  
Just copy, paste, and connect — no signup, no payment, no nonsense.  
**Updated every 30 minutes.**

### 🛠️ How to Use

1. Copy the config link (`vmess://`, `vless://`, etc.)
...
**هر ۳۰ دقیقه آپدیت می‌شود.**

### 🛠️ نحوه استفاده

1. لینک کانفیگ را کپی کنید (`vmess://`، `vless://` و…)
...
- لیست هر **۳۰ دقیقه** به‌صورت خودکار به‌روزرسانی می‌شود
